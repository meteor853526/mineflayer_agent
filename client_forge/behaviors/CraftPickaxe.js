...
function createCraftPickaxeState(bot, targets) {
    ...
    const socket_schedule_stick = new Socket_schedule(bot,targets,"stick","5. go smeltingPlant and find stick")
    const socket_schedule_cobblestone = new Socket_schedule(bot,targets,"cobblestone","5. go smeltingPlant and find cobblestone")
